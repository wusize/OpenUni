...
This dataset is originally from [tomg-group-umd/pixelprose](https://huggingface.co/datasets/tomg-group-umd/pixelprose).
We successfully downloaded 9m images and re-captioned them to more concise and generation-oriented prompts.
...
```shell
cd /path/to/OpenUni
huggingface-cli download wusize/cc12m --local-dir data/cc12m --repo-type dataset
```
